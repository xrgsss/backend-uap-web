...
<section class="grid md:grid-cols-2 gap-12 items-center">
    <div>
        ...
        <div class="mt-6 flex gap-4">
            <a href="/produk" class="px-6 py-3 bg-cyan-500 rounded-lg">Lihat Produk</a>
            <a href="/login" class="px-6 py-3 border border-white/20 rounded-lg">Login</a>
        </div>
    </div>
...
<section class="mt-24">
    ...
    <div class="grid md:grid-cols-3 gap-8" id="unggulan"></div>
</section>
@endsection
...
PRODUCTS.forEach(p => {
  el.innerHTML += `
    <div class="bg-white/5 p-5 rounded-xl hover:scale-105 transition">
